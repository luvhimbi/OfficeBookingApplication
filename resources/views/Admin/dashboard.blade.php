            ...
            <div class="card-body p-4">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <p class="mb-0">Welcome back, <strong>{{ Auth::user()->firstname }}{{ Auth::user()->lastname }}</strong>! Ready to manage your workspace facilities today?</p>
                    </div>
                ...
                <a href="{{ route('campuses.index') }}" class="text-decoration-none">
                    <div class="card  border-0 h-100 hover-shadow">
                        <div class="card-body d-flex flex-column align-items-center justify-content-center text-center">
                            ...
                            <p class="text-muted small">Add, edit, or remove campuses</p>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="{{ route('buildings.index') }}" class="text-decoration-none">
                    <div class="card  border-0 h-100 hover-shadow">
                        <div class="card-body d-flex flex-column align-items-center justify-content-center text-center">
                            ...
                            <p class="text-muted small">Add, edit, or remove buildings</p>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="{{ route('floors.index') }}" class="text-decoration-none">
                    <div class="card  border-0  h-100 hover-shadow">
                        <div class="card-body d-flex flex-column align-items-center justify-content-center text-center">
                            ...
                            <p class="text-muted small">Add, edit, or remove floors</p>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="{{ route('boardrooms.index') }}" class="text-decoration-none">
                    <div class="card  border-0  h-100 hover-shadow">
                        <div class="card-body d-flex flex-column align-items-center justify-content-center text-center">
                            ...
                            <p class="text-muted small">Add or edit boardrooms</p>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="{{ route('desks.index') }}" class="text-decoration-none">
                    <div class="card  border-0  h-100 hover-shadow">
                        <div class="card-body d-flex flex-column align-items-center justify-content-center text-center">
                            ...
                            <p class="text-muted small">Add or edit desks</p>
                        </div>
                    </div>
                </a>
            </div>
