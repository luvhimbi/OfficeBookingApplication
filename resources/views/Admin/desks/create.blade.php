...
@section('title', 'Create Desk')

@section('content')
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3><i class="bi bi-laptop me-2 text-primary"></i> Create New Desk</h3>
            ...
            <form action="{{ route('desks.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('desk_number') is-invalid @enderror"
                           id="desk_number" name="desk_number" value="{{ old('desk_number') }}" required>
                    @error('desk_number')
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save"></i> Create Desk
                    </button>
                </div>
            </form>
        </div>
