            ...
            <div class="col-md-8 mb-4">
                <div class="card border-0 shadow-lg rounded-4">
                    <div class="card-header bg-primary text-white py-3">
                        <h4 class="mb-0 fw-bold"><i class="bi bi-envelope-plus me-2"></i> Invite New User</h4>
                    </div>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-lg rounded-4">
                    <div class="card-header bg-dark text-white py-3">
                        <h5 class="mb-0 fw-bold"><i class="bi bi-clock-history me-2"></i> Recent Invites</h5>
                    </div>
                            ...
                            @foreach($invites as $invite)
                                <div class="p-3 mb-3 rounded-4 shadow-sm bg-light">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <h6 class="mb-1 fw-bold">{{ $invite->firstname }} {{ $invite->lastname }}</h6>
